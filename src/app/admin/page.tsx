...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2 tracking-tight">Selamat Datang, Admin! 👋</h2>
        <p className="text-gray-500 text-lg">Berikut adalah ringkasan data di website BEM STMIK Tazkia saat ini.</p>
      </div>
        ...
        {stats.map((stat, i) => (
          <div key={i} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <div className="flex items-center gap-5 relative z-10">
              ...
              <div>
                <p className="text-sm text-gray-500 font-medium mb-1 uppercase tracking-wider">{stat.label}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-gray-900">Top Berita Terpopuler</h3>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {topBerita?.map((item, idx) => (
              <div key={idx} className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                ...
                <div className="flex items-center gap-1.5 text-sm font-bold text-gray-700 bg-gray-100 px-3 py-1 rounded-full">
            ...
            {(!topBerita || topBerita.length === 0) && (
              <p className="text-sm text-gray-500 text-center py-4">Belum ada data berita.</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-gray-900">Top Karya Terpopuler</h3>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            {(!topKarya || topKarya.length === 0) && (
              <p className="text-sm text-gray-500 text-center py-4">Belum ada data karya.</p>
            )}
          </div>
        </div>
